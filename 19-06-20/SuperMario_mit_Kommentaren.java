...
public class SuperMario_mit_Kommentaren extends JApplet {
  ...
  */
  ...
  public void move(int a) {
    ...
    if ((moveRight == true && this.contactwithbox_sideleft(panels) == false) || (moveLeft == true && this.contactwithbox_sideright(panels) == false)) {
  ...
  public void timer_update_ActionPerformed(ActionEvent evt) {
    ...
    this.contactwithbox_bottom(panels);
    this.opponentjump();
    this.gravity();
    this.touched();
    this.opponentdie();
  ...
  public void gravity() {
    ...
    if (jumping == false && this.contactwithground_top() == false && this.contactwithopponent() != true && this.contactwithbox_top(panels) != true) {
      marioCharacter.setLocation(marioCharacter.getX(), marioCharacter.getY() + jumpSpeed);
  ...
  public boolean contactwithbox_top(ArrayList<JPanel> pan) {
    int help1 = 0;
    for (int i = 0; i < pan.size(); i++) {
      JPanel boxpanel = (JPanel) pan.toArray()[i];
      if ((marioCharacter.getY() + marioCharacter.getHeight() == boxpanel.getY() && marioCharacter.getX() + marioCharacter.getWidth() >= boxpanel.getX() && marioCharacter.getX() <= boxpanel.getX() + boxpanel.getWidth())) {
        currentJumpHeight = 0;
        help1 = 1;
        break;                                                                                                                           
      } else {
  ...
  public boolean contactwithbox_bottom(ArrayList<JPanel> pan) {
    int help2 = 0;
    for (int i = 0; i < pan.size(); i++) {
      JPanel boxpanel = (JPanel) pan.toArray()[i];
      if (marioCharacter.getY() == boxpanel.getY() + boxpanel.getHeight() && marioCharacter.getX() + marioCharacter.getWidth()>= boxpanel.getX() && marioCharacter.getX() <= boxpanel.getX() + boxpanel.getWidth()) {
        jumping = false;
        help2 = 1;
        break;
      } else {
  ...
  public boolean contactwithbox_sideleft(ArrayList<JPanel> pan){
    int help3 = 0;
    for (int i = 0; i < pan.size(); i++) {
      JPanel boxpanel = (JPanel) pan.toArray()[i];
      if (marioCharacter.getX() + marioCharacter.getWidth() == boxpanel.getX() && (marioCharacter.getY() <  boxpanel.getY() + boxpanel.getHeight() && marioCharacter.getY() + marioCharacter.getHeight() > boxpanel.getY())) {
        help3 = 1;
        break;
      } else {                                                                                                                                          
        help3 = 0;  
  ...
  public boolean contactwithbox_sideright(ArrayList<JPanel> pan){
    int help4 = 0;
    for (int i = 0; i < pan.size(); i++) {
      JPanel boxpanel = (JPanel) pan.toArray()[i];
      if (marioCharacter.getX() == boxpanel.getX() + boxpanel.getWidth() && (marioCharacter.getY() < boxpanel.getY() + boxpanel.getHeight() && marioCharacter.getY() + marioCharacter.getHeight() > boxpanel.getY())) {
        help4 = 1;
        break;
      } else {
        help4 = 0;  
